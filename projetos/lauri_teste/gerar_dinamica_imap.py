...
spec = {
    ...
    "camadas": [
        ...
        {"id": "lote65", "fonte": "arquivo:" + L65, "filtro": "",
         "estilo": {"nome": "Fazenda Trevisol (Lote 65)", "linha": "#ff2d00",
                    "preenchimento": "none", "opacidade": 1.0, "largura": 2.4,
    ...
    "legenda": {
        ...
        "itens": [
            {"rotulo": "Fazenda Trevisol (Lote 65)", "tipo": "linha", "cor": "#ff2d00", "largura": 2.4},
            {"rotulo": "Lote Rural nº 66-A", "tipo": "linha", "cor": "#00b0f0", "largura": 2.4},
    ...
    "elementos_layout": {
        "legenda": True, "escala_grafica": True, "norte": True, "grade": True,
