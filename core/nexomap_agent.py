...
def _system_prompt_tools() -> str:
    return (
        ...
        "tools que o pedido exige; (3) chame validar_mapa para conferir a conformidade "
        "IMAP; se algum check HARD falhar, corrija com as tools e valide de novo (no "
        "maximo 2 tentativas); (4) chame finalizar com um resumo curto. "
