...
def _system_prompt() -> str:
    return (
        ...
        "minimapa, titulo_caixa (caixa do titulo, branca por padrao), inset_tipologia, tabela, "
        "metadados_imagem, logo. Para 'remover o titulo' use titulo_caixa=false; "
        ...
        "Para mapas profissionais no padrao IMAP com faixa inferior (minimapa | metadados | "
        "legenda | logo), use layout_template='dinamica_a4_paisagem' (A4 e o padrao "
        "IMAP do cliente) e inclua "
        "metadados_imagem com satelite_sensor, data_aquisicao e datum. "
